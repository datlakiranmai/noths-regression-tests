Feature: Login [Rollback Legacy user]
  As a customer
  ...
  @e2e_cognito_check @cog_e2e @174.01
  Scenario: [Rollback Legacy user] 174.01 - A customer is able to successfully login via the header
  ...
  @e2e_cognito_check @cog_e2e @174.02
  Scenario: [Rollback Legacy user] 174.02 - A customer is able to successfully login via favourites
