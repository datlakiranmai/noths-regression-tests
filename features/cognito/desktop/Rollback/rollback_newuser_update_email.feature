Feature: Update Email address [Rollback New user]
  ...
  @cog_e2e @180.01
  Scenario: [Rollback New user] 180.01 - A customer should be able to update their email address on the my details page
