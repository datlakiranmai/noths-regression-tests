Feature: Checkout Login [Rollback Legacy user]
  ...
  @e2e_cognito_check @cog_e2e @194.01
  Scenario: [Legacy user] 194.01 - A customer should be able to login during the checkout of a standard product
  ...
  @e2e_cognito_check @cog_e2e @194.02
  Scenario: [Legacy user] 194.02 - A customer should be able to login during the gift voucher checkout
